...
void tour(t_joueur* p_joueur, t_case plateau[], t_banque* p_banque); // Fais faire un tour à un joueur
bool acheter_maison_hotel(t_joueur* p_joueur, t_case plateau[], t_banque* banque); // Achat de maison et d'hotel
