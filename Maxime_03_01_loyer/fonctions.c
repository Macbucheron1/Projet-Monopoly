...
// fonction pour loyer
bool loyer(t_joueur tab_joueur[], int i, t_case plateau[]) // En cours par Nathan
{
    ...
    */
    ...
    else if((plateau[tab_joueur[i].position].num_joueur != tab_joueur[i].numero) && (plateau[tab_joueur[i].position].num_joueur != 0) && (plateau[tab_joueur[i].position].groupe_cartes == 9))
    {
