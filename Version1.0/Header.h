...
typedef struct //case(ou cartes) du plateau
{
    ...
    int num_joueur; //nom du propriétaire(NONE si ya pas)
...
void sortie_prison(int* liste_de, t_joueur* joueur); // Permet de faire sortir le joueur de prison

//instanciation
t_joueur creation_joueur(void); // permet de créer une instance de structure joueur
t_case creation_case(int position,int valeur, int val_maison, int val_hotel, int groupe_cartes); //permet de créer une instance de strucutre de case
