...
void tirer_corruption(t_joueur tab_joueur[],int i, char* liste_corruption) // LUC fait
{
    ...
    */
    ...
    case 11:
        ...
        {
            en_faillite(tab_joueur, i, 150, banque, 0, plateau, liste_comite, liste_corruption);
        }
        break;
    case 12:
    ...
    case 13:
        ...
        {
            en_faillite(tab_joueur, i, 15, banque, 0, plateau, liste_comite, liste_corruption);
        }
        break;
    case 14:
    ...
    case 15:
        ...
        {
            en_faillite(tab_joueur, i, 20, banque, 0, plateau, liste_comite, liste_corruption);
        }
        break;
    }
}
...
void tirer_comite(t_joueur tab_joueur[],int i, char* liste_comite[]) // LUC fait
{
    ...
    */
    ...
    case 3:
        ...
        {
            en_faillite(tab_joueur, B, 10, banque, 0, plateau, liste_comite, liste_corruption);
        }
       if(tab_joueur[C].argent >= 10)
        {
        ...
        {
            en_faillite(tab_joueur, C, 10, banque, 0, plateau, liste_comite, liste_corruption);
        }
        if(tab_joueur[D].argent >= 10)
        {
        ...
        {
            en_faillite(tab_joueur, D, 10, banque, 0, plateau, liste_comite, liste_corruption);
        }
        break;
    case 4:
    ...
    case 5:
        ...
        {
            en_faillite(tab_joueur, i, 100, banque, 0, plateau, liste_comite, liste_corruption);
        }
        break;
    case 6:
    ...
    case 11:
        ...
        {
            en_faillite(tab_joueur, i, 50, banque, 0, plateau, liste_comite, liste_corruption);
        }
        break;
    case 12:
