...
void tour(t_joueur tab_joueur[], t_case plateau[], t_banque* p_banque, char* liste_corruption[]); // Fais faire un tour à un joueur
bool acheter_maison_hotel(t_joueur tab_joueur[], int i, t_case plateau[], t_banque* banque); // Achat de maison et d'hotel
bool loyer(t_joueur tab_joueur[], int i, t_case plateau[]); // Permet de faire payer le loyer
...
void menu(t_joueur tab_joueur[], t_case plateau[], t_banque* p_banque, char* liste_corruption[]);
