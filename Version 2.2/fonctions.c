...
void deplacement(int* liste_de, t_joueur tab_joueur[], int i) // NATHAN
{
...
// Fonction de deplacement de joueur
void aller_a(int indice_case, t_joueur tab_joueur[], int i) // NATHAN
{
...
void entrer_prison(t_joueur tab_joueur[], int i) // NATHAN
{
...
// fonction pour prison
bool sortie_prison(int* liste_de, t_joueur tab_joueur[], int i) // NATHAN
{
...
// fonction creation d'instance
t_joueur creation_joueur(int numero) // LUC
{
...
void creation_tab_joueur(t_joueur tab_joueur[]) // NATHAN
{
...
void afficher_joueur(t_joueur j) // LUC
{
    ...
    */
    ...
    printf("nom:%s\nnumero:%d\nposition:%d\nargent:%d\npropriete:%d\netes-vous en prison?:%d\ncombien de tour en prison:%d\nnb de cartes sorites de prison:%d\nfaillite: %d\n",j.nom,j.numero,j.position,j.argent,j.proprietes,j.en_prison,j.tour_prison,j.carte_sortie_prison, j.en_faillite);
    printf("\n"); //pour de la lisibilité
}

// fonction affichage d'instance
void afficher_case(t_case c) // LUC
{
...
// fonction affichage d'instance
void afficher_banque(t_banque banque) // LUC
{
...
// fonction pour loyer
bool loyer(t_joueur tab_joueur[], int i, t_case plateau[]) // Maxime
{
...
// Fonction de tour
void tour(t_joueur tab_joueur[], t_case plateau[], t_banque* p_banque, char* liste_corruption[]) // NATHAN
{
...
bool acheter_maison_hotel(t_joueur tab_joueur[], int i, t_case plateau[], t_banque* banque) // MAXIME
{
...
// Fonction affichage
void gotoligcol( int lig, int col ) // MAXIME
{
    /* Va a l'emplacement
...
void Color(int couleurDuTexte,int couleurDeFond) // MAXIME
{
...
// Fonction d'affichage
int Longueur(int Valeur) // A commenter (maxime) // MAXIME
{
	int Retour = 0;
	if(Valeur == 0)
    {
...
// Fonction d'affichage
void afficher_valeur_case(int indice, t_case plateau[]) // MAXIME
{
...
// Fonction d'affichage
void afficher_nom_proprietaire(int indice, t_case plateau[], t_joueur tab_joueur[], int num_joueur) // MAXIME
{
...
//fonction d'affichage
void creation_sous_case1(t_case plateau[], t_joueur tab_joueur[], int i) // MAXIME
{
...
//fonction d'affichage
void creation_sous_case2(t_case plateau[], t_joueur tab_joueur[], int i) // MAXIME
{
...
//fonction d'affichage
void creation_sous_case3(t_case plateau[], t_joueur tab_joueur[], int i) // MAXIME
{
...
// Fonction d'affichage
void afficher_plateau(t_case plateau[], t_joueur tab_joueur[]) // MAXIME
{
...
// fonction d'affichage
void afficher_milieu_plateau(t_case plateau[], t_joueur tab_joueur[],int i, int de[]) // NATHAN
{
    gotoligcol(16, 80);
...
// fonction de jeu
bool hypotheque(t_joueur tab_joueur[],int i, t_case plateau[], t_banque* p_banque) // NATHAN
{
...
// fonction affichage
void afficher_liste(char* liste[],int i) // A commenter luc
{
...
// fonction de jeu
void tirer_corruption(t_joueur tab_joueur[],int i, char* liste_corruption) // A corriger luc
{
    /* Procedure qui tire une carte corruption et l'effectue
       Prend en paramètre la liste de joueur, l'indice du joueur qui joue, la liste des textes qui décrivent la liste de corruption
       Ne renvoie rien
    */
    srand( time( NULL ) );
    ...
    case 3:
        ...
        int nombre_maisons=0;
        nombre_maisons=nb_maisons_joueur(tab_joueur,i);
        int nombre_hotels=0;
        nombre_hotels=nb_hotels_joueur(tab_joueur,i);
    ...
    case 8:
        ...
        int nombre_maisons2=0;
        nombre_maisons2=nb_maisons_joueur(tab_joueur,i);
        int nombre_hotels2=0;
        nombre_hotels2=nb_hotels_joueur(tab_joueur,i);
...
// fonction utilitaire
int nb_maisons_joueur(t_joueur tab_joueur[],int i) // LUC
{
...
// fonction utilitaire
int nb_hotels_joueur(t_joueur tab_joueur[],int i) // LUC
{
...
// fonction de jeu
bool achat(t_joueur tab_joueur[],t_case plateau[],int i) // KEIS
{
...
// Fonction de jeu
void impot(t_joueur tab_joueur[],t_case plateau[],int i) // KEIS
   {
...
// fonction de jeu
bool salaire(t_joueur tab_joueur[],int de[2],int i) // KEIS
{
...
// Fonction d'affichage
void menu(t_joueur tab_joueur[], t_case plateau[], t_banque* p_banque, char* liste_corruption[]) // NATHAN
{
    system("cls");
    Color(12, 0);
    ...
    if (choix[0] == '1')
    {
        ...
        tour(tab_joueur, plateau, p_banque, liste_corruption);
    }
    else if (choix[0] == '2')
    {
...
// Fonction utilitaire
int nb_gare_joueur(t_case plateau[], int i) // MAXIME
{
    /*
