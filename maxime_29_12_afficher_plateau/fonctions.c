...
int acheter_maison_hotel(t_joueur* p_joueur, t_case plateau[], t_banque* banque)
...
void afficher_plateau(t_case plateau[])
...
//ne renvoie rien
{
    ...
    for(int i=0;i<32 ; i++)
    {
        ...
        printf("|");
        if(i == 7)//permet de faire les saut de ligne(pareil pour les 2 suivant)
        {
            printf("\n\n\n\n\n\n|");
        }
        else if(i ==15)
