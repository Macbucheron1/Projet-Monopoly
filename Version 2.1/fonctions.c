...
// Fonction d'affichage
int Longueur(int Valeur) // A commenter (maxime)
{
	int Retour = 0;
	if(Valeur == 0)
    {
...
int update_propriete(t_joueur tab_joueur[],int i, t_case plateau[])
{
    ...
    */
     ...
     for (int j = 0; j < 32; j++) // Remplit le tableau de propriété du joueur
    {
        ...
        {
            tab_joueur[i].proprietes[total] = creation_case(50, 0, 0, 0, 50, "Rien", 50, 50, 0, 0);
        }
        total+=1;
    }
    return nb;
