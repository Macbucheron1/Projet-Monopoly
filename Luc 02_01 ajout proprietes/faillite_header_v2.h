...
bool en_faillite(t_joueur tab_joueur[],int i,int montant,t_banque* b,int proprietaire); //on fait appel à la fonction lors de n'importe quel paiement (à la banque ou à un joueur), si proprietaire = 0 c'est la banque
