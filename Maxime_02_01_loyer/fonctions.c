...
int nb_gare_joueur(t_case plateau[], int i)
{
    ...
    else if(plateau[11].num_joueur == i)
    {
        nb_gare+=1;
    }
    else if (plateau[19].num_joueur == i)
    {
        nb_gare += 1;
    }
    else if(plateau[27].num_joueur == i)
    {
        nb_gare+=1;
    }
    return nb_gare;
...
// fonction pour loyer
bool loyer(t_joueur tab_joueur[], int i, t_case cases) // En cours par Nathan
{
    ...
    */
    t_banque banque;
    int option;
    if ((cases.num_joueur != tab_joueur[i].numero) && (cases.num_joueur != 0) && (cases.groupe_cartes <= 8))//regarde si la case appartient a quelqu'un d'autre que le joueur et si c'est une propriete
    {
        if(cases.nb_maison == 0 && cases.nb_hotel == 0)
        {
           option = 0;
        }
        else if(cases.nb_maison ==1 && cases.nb_hotel == 0)
        {
            option = 1;
        }
        else if(cases.nb_maison == 2 && cases.nb_hotel == 0)
        {
            option = 2;
        }
        else if(cases.nb_maison == 3 && cases.nb_hotel == 0)
        {
            option = 3;
        }
        else if(cases.nb_maison == 4 && cases.nb_hotel == 0)
        {
            option = 4;
        }
        else if(cases.nb_maison == 0 && cases.nb_hotel == 1)
        {
            option = 5;
        }
        switch(option)
        {
            case 0:
            {
                if(tab_joueur[i].argent >= cases.base_loyer)
                {
                    tab_joueur[i].argent -= cases.base_loyer;
                    tab_joueur[cases.num_joueur].argent += cases.base_loyer;
                }
                else
                {
            ...
            case 1:
            {
                if(tab_joueur[i].argent >= cases.loyer_1_maison)
                {
                    tab_joueur[i].argent -= cases.loyer_1_maison;
                    tab_joueur[cases.num_joueur].argent += cases.loyer_1_maison;
                }
                else
                {
            ...
            case 2:
            {
                if(tab_joueur[i].argent >= cases.loyer_2_maison)
                {
                    tab_joueur[i].argent -= cases.loyer_2_maison;
                    tab_joueur[cases.num_joueur].argent += cases.loyer_2_maison;
                }
                else
                {
                    en_faillite(tab_joueur, i, cases.loyer_2_maison, banque, cases.num_joueur);
                }
                break;
            }
            case 3:
            {
                if(tab_joueur[i].argent >= cases.loyer_3_maison)
                {
                    tab_joueur[i].argent -= cases.loyer_3_maison;
                    tab_joueur[cases.num_joueur].argent += cases.loyer_3_maison;
                }
                else
                {
            ...
            case 4:
            {
                if(tab_joueur[i].argent >= cases.loyer_4_maison)
                {
                    tab_joueur[i].argent -= cases.loyer_4_maison;
                    tab_joueur[cases.num_joueur].argent += cases.loyer_4_maison;
                }
                else
                {
            ...
            case 5:
            {
                if(tab_joueur[i].argent >= cases.loyer_1_hotel)
                {
                    tab_joueur[i].argent -= cases.loyer_1_hotel;
                    tab_joueur[cases.num_joueur].argent += cases.loyer_1_hotel;
                }
                else
                {
    ...
    else if((cases.num_joueur != tab_joueur[i].numero) && (cases.num_joueur != 0) && (cases.groupe_cartes == 9))
    {
        int nb_gare = nb_gare_joueur(t_case plateau[], cases.num_joueur);
        if(nb_gare == 1)
        {
            if(tab_joueur[i].argent >= 25)
            {
                tab_joueur[i].argent -= 25;
                tab_joueur[cases.num_joueur].argent += 25;
            }
            else
            {
        ...
        else if(nb_gare == 2)
        {
            ...
            {
                tab_joueur[i].argent -= 50;
                tab_joueur[cases.num_joueur].argent += 50;
            }
            else
            {
        ...
        else if(nb_gare ==3)
        {
            if(tab_joueur[i].argent >= 100)
            {
                ...
                tab_joueur[cases.num_joueur].argent += 100;
            }
            else
            {
        ...
        else if(nb_gare ==4)
        {
            if(tab_joueur[i].argent >= 200)
            {
                ...
                tab_joueur[cases.num_joueur].argent += 200;
            }
            else
            {
